        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <p class="text-sm text-gray-400 leading-relaxed">
                    Portal informasi UMKM dan destinasi wisata Desa Kopeng, Kecamatan Getasan, Kabupaten Semarang, Jawa Tengah.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('home') }}" class="text-sm text-gray-400 hover:text-primary-400 transition-colors">Beranda</a></li>
