    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div>
                    @if($tourism->categories && $tourism->categories->count() > 0)
                        <div class="flex flex-wrap gap-2 mb-3">
                            @foreach($tourism->categories as $cat)
                                <span class="inline-block text-xs font-medium text-blue-600 bg-blue-50 px-3 py-1 rounded-full">{{ $cat->name }}</span>
                            @endforeach
                        </div>
                    @endif
